...
Hello!	| ไม่สามารถใช้ได้ | เพราะว่ามีเครื่องหมาย !	
w*h 	| ไม่สามารถใช้ได้ | เพราะว่ามีเครื่องหมาย * เครื่องอาจจะคิดว่าป็น การคำนวนทางคณิตศาสตร์ะรทำ			
time	| สามารถใช้ได้ |			
do	| ไม่สามารถใช้ได้ | เพราะมันคิดว่าเป็นคำสั่ง do			
Do	| สามารภใช้งานได้ |			
21November	| ไม่สามารถใช้งานได้ | ไม่สามารถขึ้นต้นด้วยเล๘ได้		
ladkrabang	| สามารถใช้ได้ |			
Student ID	| ไม่สามารถใช้ได้ | เพราะว่ามีช่องว่าง			
...
![](https://github.com/UkritFB/LAB-07/blob/master/7CALL.PNG?raw=true)
...
Earth |	149,600,000 km	|0.9995390361|	8.3294919676
Mars |	227,940,000 km	|1.5229607479|	12.6913395662
Jupiter |	778,330,000 km	|5.2003423662|43.3361863848	
Uranus |	2,873,550,000 km|19.1993676285|		159.9947302378
Neptune |	4,501,000,000 km|30.0730294222|	250.6085785179	
Pluto |	5,945,900,000 km|39.726996981|	331.0583308176	
#Mercury
...
#Earth
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.3.PNG)

#Mars
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.4.PNG)

#Jupiter
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.5.PNG)

#Uranus
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.6.PNG)

#Neptune
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.7.PNG)
#Pluto
![](https://raw.githubusercontent.com/UkritFB/LAB-07/master/7.8.PNG)
##คลาส Math 
